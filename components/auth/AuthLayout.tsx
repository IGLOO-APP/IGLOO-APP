      ...
      <div className='hidden md:flex flex-1 flex-col items-start justify-center p-11 relative z-20 bg-[#0a1618]'>
        ...
        <div className='space-y-3 relative z-10'>
          ...
          <p className='max-w-[320px] text-slate-500 text-sm font-medium leading-relaxed'>
            A plataforma definitiva para gestão de kitnets e imóveis com padrão enterprise e design
            intuitivo.
          </p>
        </div>
      ...
      <div className='flex-1 flex items-center justify-center p-4 relative z-10 bg-[#060d0e] border-l border-white/[0.03]'>
        <div className='w-full max-w-[400px]'>
          ...
          <div className='text-center mb-6 group'>
            <div
              className='mx-auto h-10 w-10 rounded-xl flex items-center justify-center text-white text-xl font-black mb-3 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3'
              style={{
            ...
            <p className='text-slate-600 text-[8px] font-bold tracking-[0.3em] uppercase'>
              {subtitle}
            </p>
          </div>

          ...
          <div className='space-y-3'>
            ...
            <div className='space-y-2'>
              {reasons.map((r) => (
                <label
                  key={r}
                  className='flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 cursor-pointer transition-colors'
                >
                  <input
                    type='radio'
                    name='reason'

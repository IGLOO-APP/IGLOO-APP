    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div className="relative overflow-hidden bg-slate-900 rounded-[32px] p-8 text-white shadow-2xl border border-white/5">
        ...
        <div className="relative flex flex-col md:flex-row items-center gap-8">
          <div className="relative group">
            <div className="w-32 h-32 rounded-3xl bg-primary flex items-center justify-center text-4xl font-black text-slate-900 shadow-xl shadow-primary/20 overflow-hidden ring-4 ring-white/10 group-hover:scale-105 transition-transform duration-500">
              {avatar ? (
            ...
            <button className="absolute -bottom-2 -right-2 p-3 bg-white text-slate-900 rounded-2xl shadow-xl hover:bg-primary hover:text-slate-900 transition-all transform hover:rotate-12 active:scale-95 border-4 border-slate-900">
              <Camera size={18} />
            </button>
          </div>
          ...
          <div className="text-center md:text-left space-y-2">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
              <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-black uppercase tracking-widest border border-primary/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-surface-dark rounded-[32px] p-8 border border-gray-100 dark:border-white/5 shadow-sm">
            ...
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-black/20 border border-transparent focus:border-primary outline-none transition-all text-sm font-bold text-slate-900 dark:text-white"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Camera className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors" size={18} />
                  <input 
                    type="text" 
                    value={avatar}
                ...
                <button 
                  ...
                  className={`flex items-center gap-3 px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest transition-all active:scale-95 shadow-xl ${
                    success 
                      ...
                      : 'bg-slate-900 text-white shadow-slate-900/20 hover:bg-primary hover:text-slate-900'
                  }`}
                >
                  {isUpdating ? (
                    <>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-[32px] p-8 border border-gray-100 dark:border-white/5 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-black/20 border border-transparent hover:border-primary/20 transition-all cursor-pointer group">
              ...
              <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-black/20 border border-transparent hover:border-primary/20 transition-all cursor-pointer group">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white dark:bg-surface-dark flex items-center justify-center shadow-sm">
                    <Fingerprint size={18} className="text-slate-400 group-hover:text-primary transition-colors" />
                  </div>
                  <div>
        ...
        <div className="space-y-6">
          <div className="bg-primary rounded-[32px] p-8 text-slate-900 shadow-xl shadow-primary/20">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-center gap-3 bg-slate-950/10 p-3 rounded-2xl backdrop-blur-sm border border-slate-950/10 text-slate-900">
                  <item.icon size={16} />
          ...
          <div className="bg-white dark:bg-surface-dark rounded-[32px] p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-slate-50 dark:bg-black/20 hover:bg-slate-100 dark:hover:bg-primary/10 transition-all group">
              ...
              <button className="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-slate-50 dark:bg-black/20 hover:bg-slate-100 dark:hover:bg-primary/10 transition-all group col-span-2">
                <CreditCard size={18} className="text-slate-400 group-hover:text-primary" />

...
const AdminManager: React.FC = () => {
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      // Log action
      await adminService.logActivity('invite_admin', 'system', formData.email, {
        name: formData.name,
                ...
                >
                    ...
                    <div className='flex items-center gap-2'>
                      {admin.is_pending ? (
                        <>
                          ...
                          <span className='text-xs font-bold text-amber-500'>Convite pendente</span>
                        </>
                      ) : (
                        <>
                          <div
                  ...
                  <td className='px-6 py-4 text-right relative'>
                    <button
                      onClick={() =>
                        setActiveDropdown(
                          activeDropdown === admin.id.toString() ? null : admin.id.toString()
                        )
                      }

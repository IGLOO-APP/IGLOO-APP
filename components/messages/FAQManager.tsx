          ...
          <div className='px-6 py-3 bg-primary/10 border-b border-primary/20 flex items-center gap-3'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-[11px] text-slate-600 dark:text-slate-300 font-medium'>
                São atalhos de texto para perguntas frequentes. Ao conversar com um locatário, você
                poderá enviar estas respostas completas com apenas um clique, economizando tempo.
              </p>
            </div>
          </div>

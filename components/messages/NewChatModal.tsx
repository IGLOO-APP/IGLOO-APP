      ...
      <div className='flex flex-col bg-background-light dark:bg-background-dark max-h-[80vh] overflow-hidden'>
        ...
        <div className='flex-1 overflow-y-auto p-6 space-y-3 custom-scrollbar'>
          <h3 className='text-[10px] font-black text-slate-400 uppercase tracking-widest px-1 mb-4 flex items-center justify-between'>
            ...
            <span className='bg-slate-100 dark:bg-white/5 px-2 py-0.5 rounded text-slate-500'>
              ...
              {filteredTenants.map((t) => (
                ...
                >
                  <div className='shrink-0'>
                    <div
                      className={`w-12 h-12 rounded-2xl ${getAvatarColor(t.name)} flex items-center justify-center text-white font-black text-lg shadow-lg shadow-black/5 group-hover:scale-105 transition-transform`}
                    >
                      {t.avatar_url ? (
                        <img
                          src={t.avatar_url}
                  ...
                  <div className='flex-1 min-w-0'>
                    <h4 className='text-sm font-black text-slate-900 dark:text-white truncate tracking-tight group-hover:text-primary transition-colors'>
                      {t.name}
                    </h4>

...
export const ContextPanel: React.FC<ContextPanelProps> = ({
  ...
  return (
    <div
      className={`fixed lg:relative inset-y-0 right-0 w-[85%] sm:w-72 md:w-80 lg:w-72 bg-white dark:bg-background-dark border-l border-gray-100 dark:border-white/5 flex flex-col h-full z-[60] lg:z-10 transition-transform duration-300 shadow-2xl lg:shadow-none min-h-0`}
    >
      <div className='h-14 px-4 flex items-center justify-between border-b border-gray-100 dark:border-white/5 shrink-0 bg-white/80 dark:bg-background-dark/80 backdrop-blur-xl sticky top-0 z-10'>
      ...
      <div className='flex border-b border-gray-100 dark:border-white/5 shrink-0'>
        <button
          ...
          className={`flex-1 py-3 text-[8px] font-black uppercase tracking-widest transition-all relative ${
        ...
        {activeRightTab === 'ticket' ? (
            ...
            activeChat.ticket ? (
              <div className='space-y-4'>
                ...
                <div className='p-4 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5'>
                  <h4 className='text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-tight mb-1.5'>
                    {activeChat.ticket.title}
                  </h4>
                  <p className='text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium mb-3'>
                    {activeChat.ticket.description || 'Chamado de suporte registrado no sistema.'}
                  </p>
                  <div className='flex items-center gap-2'>
                    <div className='flex items-center gap-1 px-1.5 py-1 bg-white dark:bg-black/20 rounded-lg border border-slate-100 dark:border-white/5'>
                ...
                {activeChat.ticket.status !== 'completed' && (
                  <button
                    ...
                    className='w-full h-10 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-black text-[9px] uppercase tracking-[0.2em] transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-black/10 flex items-center justify-center gap-1.5'
                  >
              ...
              <div className='space-y-4'>
                <div className='p-4 bg-emerald-500/5 rounded-2xl border border-emerald-500/10'>
                  ...
                  <div className='flex items-center gap-2 mt-3 text-[8px] font-bold text-slate-500'>
                    <Calendar size={10} />
                ...
                <div className='space-y-3'>
                  ...
                  {[1, 2].map((i) => (
                    <div
                      key={i}
                      className='flex items-center justify-between p-3 bg-white dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5'
                    >
                      <div className='flex flex-col'>
              ...
              <div className='flex flex-col items-center justify-center py-8 text-center opacity-40 grayscale'>
                <FileText size={36} strokeWidth={1} />
                <p className='mt-3 text-[9px] font-black uppercase tracking-widest'>
            ...
            <div className='space-y-4 pt-3'>
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-1'>
                  ...
                  <span className='text-[7px] font-black text-emerald-500 uppercase'>Ao vivo</span>
                </div>
              </div>

              <div className='relative space-y-5 before:absolute before:left-[11px] before:top-2 before:bottom-0 before:w-0.5 before:bg-slate-100 dark:before:bg-white/5'>
                <div className='relative flex gap-3 items-start group'>
                  <div className='w-6 h-6 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center z-10 shrink-0 border-4 border-white dark:border-[#0f172a] shadow-sm'>
                ...
                {activeChat.ticket && (
                  <div className='relative flex gap-3 items-start group'>
                    <div className='w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center z-10 shrink-0 border-4 border-white dark:border-[#0f172a] shadow-sm'>
          ...
          <div className='space-y-4'>
            <div className='p-4 bg-cyan-500/5 rounded-2xl border border-cyan-500/10 flex flex-col items-center text-center'>
              <div className='w-12 h-12 bg-gradient-to-tr from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-cyan-500/20 mb-3'>
                <Shield size={22} />
              </div>
              <h4 className='text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-wider mb-2'>
                Suporte Oficial Igloo
              </h4>
              <p className='text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium mb-3'>
                Nossa equipe de especialistas operacionais está pronta para te atender.
              </p>
              <div className='w-full p-3 bg-white dark:bg-black/20 rounded-2xl border border-slate-100 dark:border-white/5 space-y-2.5 text-left'>
                <div className='flex items-center gap-2.5'>
                  <Clock size={12} className='text-cyan-500 shrink-0' />
                  <div>
                    <p className='text-[8px] font-black uppercase text-slate-950 dark:text-white leading-none'>
                      Tempo de Resposta
                    </p>
          ...
          <div className='space-y-5'>
            <div className='space-y-3'>
              ...
              <div className='group relative overflow-hidden rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
                ...
                <div className='p-4'>
                  <h4 className='text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-tight leading-snug'>
                    {activeChat.property}
                  </h4>
                  ...
                  <button className='mt-3 flex items-center gap-1.5 text-[8px] font-black text-primary uppercase tracking-widest group-hover:gap-2 transition-all'>
            ...
            <div className='space-y-3'>
              ...
              <div className='space-y-2'>
                <div className='flex items-center gap-3 p-3 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5'>
                  <div className='w-8 h-8 rounded-full bg-slate-100 dark:bg-white/10 flex items-center justify-center text-slate-400 shrink-0'>
                    <User size={14} />
                  </div>

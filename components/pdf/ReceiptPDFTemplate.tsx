        ...
        <View style={styles.card}>
          ...
          <View style={styles.section}>
            <Text style={styles.statement}>
              ...
              {tenantName || 'Inquilino registrado'}, a importância de R$ {formattedAmount}{' '}
              referente ao pagamento de &quot;{transaction.title}&quot; para o imóvel{' '}
              {transaction.propertyName || 'Imóvel Cadastrado'}, liquidado com sucesso na data de{' '}
              {formattedDate}.
            </Text>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              Comprovante emitido eletronicamente via IGLOO Property Manager
            </Text>
          </View>
        </View>
      </Page>

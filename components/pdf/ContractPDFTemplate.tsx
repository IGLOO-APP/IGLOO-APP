    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Gerado eletronicamente via IGLOO Property Manager
          </Text>
        </View>
      ...
      <Page size="A4" style={styles.signaturePage}>
        ...
        <Text style={styles.sigSubtitle}>
          Este documento foi gerado e assinado digitalmente em conformidade com as diretrizes e legislação do ecossistema de assinatura eletrônica IGLOO.
        </Text>
        ...
        <View style={styles.sigRow}>
          ...
          <View style={styles.sigCol}>
            ...
            <Text style={styles.sigMeta}>E-mail: {data.tenantEmail || (data.tenantName ? `${data.tenantName.toLowerCase().replace(/\s+/g, '')}@exemplo.com` : '________________________')}</Text>

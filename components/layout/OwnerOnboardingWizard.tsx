...
export const OwnerOnboardingWizard: React.FC<OwnerOnboardingWizardProps> = ({ onComplete }) => {
  ...
  return (
    <Dialog open onOpenChange={() => {}}>
      <DialogContent
        className='max-h-[90vh] overflow-y-auto p-0 gap-0 md:max-w-2xl'
            ...
            <div className='flex-1 flex flex-col animate-fadeIn'>
              <div className='p-8 pb-0'>
                ...
                <p className='text-sm text-slate-500 font-medium mb-6'>
                  Sem imóveis, não há gestão. Você pode começar com um cadastro básico e detalhar
                  depois.
                </p>
              </div>
          ...
          {currentStep === 'financial' && (
            <div className='flex-1 flex flex-col animate-fadeIn'>
              <div className='p-8 pb-0'>
                ...
                <p className='text-sm text-slate-500 font-medium mb-6'>
                  Configure sua chave PIX para que os inquilinos paguem direto na sua conta.
                </p>
              </div>
              ...
              <div className='flex-1 px-8 space-y-6'>
                ...
                <div className='p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-2xl border border-emerald-100 dark:border-emerald-500/20 flex gap-3'>
                  ...
                  <p className='text-[11px] text-emerald-700 dark:text-emerald-300 leading-relaxed'>
                    Seus dados bancários são usados apenas para gerar os informativos de pagamento
                    para o inquilino. O IGLOO não movimenta seu dinheiro.
                  </p>
                </div>
              </div>
          ...
          {currentStep === 'vetting' && (
            <div className='flex-1 flex flex-col animate-fadeIn'>
              <div className='p-8 pb-0'>
                ...
                <p className='text-sm text-slate-500 font-medium mb-6'>
                  Defina o que é obrigatório para seus inquilinos fornecerem no primeiro acesso.
                </p>
              </div>
                    ...
                    <div className='ml-auto'>
                      ...
                      <button
                        ...
                        className={`w-10 h-6 rounded-full relative transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary/30 ${
                          rules[item.key] ? 'bg-primary' : 'bg-slate-200 dark:bg-white/10'
                        }`}
                      >
                        <span
          ...
          {currentStep === 'done' && (
            <div className='flex-1 flex flex-col items-center justify-center p-8 text-center space-y-8 animate-fadeIn'>
              ...
              <div>
                ...
                <p className='text-slate-500 dark:text-slate-400 font-medium max-w-sm mx-auto'>
                  Você acaba de profissionalizar sua gestão. Seu dashboard está pronto para
                  monitorar seus ativos e rendimentos.
                </p>
              </div>
              <button
                onClick={onComplete}

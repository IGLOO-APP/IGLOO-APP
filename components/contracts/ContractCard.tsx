        ...
        <div className='flex justify-between items-start mb-4'>
          <div className='space-y-1.5'>
            <div className='flex items-center gap-2'>
              <span
                className={`text-[9px] font-black px-2 py-0.5 rounded-lg uppercase tracking-[0.15em] border ${statusColor} shadow-sm`}
              >
                {statusLabel}
              </span>
          ...
          <div className='flex flex-col items-end'>
            <div className='bg-slate-900 dark:bg-white px-3 py-1 rounded-tr-xl rounded-bl-xl shadow-lg'>
              <span className='text-[9px] font-black text-white dark:text-slate-900 uppercase tracking-[0.2em] opacity-80'>
                Valor Mensal
              </span>
              <p className='text-sm font-black text-white dark:text-slate-900 font-mono'>
                {contract.value}
              </p>
            </div>

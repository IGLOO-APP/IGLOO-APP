    ...
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      ...
      >
        <DialogHeader className='px-6 py-4 border-b border-border flex-shrink-0'>
          <DialogTitle className='text-xl font-bold'>{`Contrato #${contract.contract_number}`}</DialogTitle>
          <DialogDescription />
        </DialogHeader>
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                      <div className='p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
                        <div className='flex items-center justify-between mb-1'>
                          ...
                          <div
                            title='Base legal: Jurisprudência consolidada do STJ (Contratos Civis). Limite usual de 10% para evitar abusividade.'
                            className='cursor-help text-slate-300 hover:text-primary transition-colors'
                          >
                            <Info size={10} />
                          </div>
                        </div>
                      ...
                      <div className='p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
                        <div className='flex items-center justify-between mb-1'>
                          ...
                          <div
                            title='Art. 406 do Código Civil: Limite de 1% ao mês (0,033% ao dia) para evitar usura em contratos civis.'
                            className='cursor-help text-slate-300 hover:text-primary transition-colors'
                          >
                            <Info size={10} />
                          </div>
                      ...
                      <div className='p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
                        <div className='flex items-center justify-between mb-1'>
                          ...
                          <div
                            title='Lei 10.192/01: Proíbe reajustes com periodicidade inferior a 1 ano em contratos de locação.'
                            className='cursor-help text-slate-300 hover:text-primary transition-colors'
                          >
                            <Info size={10} />
                          </div>
                      ...
                      <div className='p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
                        ...
                        <div className='flex items-center justify-between'>
                          ...
                          <span className='text-[8px] font-black bg-amber-500/10 text-amber-600 px-1 py-0.5 rounded'>
                            em 8 meses
                          </span>
                        </div>
                      </div>
                ...
                {contract.pdf_url ? (
                  <>
                    <div className='flex-1 relative bg-slate-100 dark:bg-black/20'>
                      {/* Verifica se é o Google Viewer e extrai a URL real do PDF */}
                      {(() => {
                        let directPdfUrl = contract.pdf_url;

                        // Se a URL for do Google Docs Viewer, extraímos a URL real do PDF
                        if (directPdfUrl.includes('docs.google.com/viewer')) {
                          ...
                          if (extractedUrl) {
                            directPdfUrl = decodeURIComponent(extractedUrl);
                          }
                        }

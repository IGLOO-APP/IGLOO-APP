...
export const PropertyDocuments: React.FC<PropertyDocumentsProps> = ({ property, onClose }) => {
  ...
  const [documents, setDocuments] = useState<PropertyDocument[]>([
    {
      id: '1',
      name: 'Contrato de Locação Digital - Assinado',
      category: 'Jurídico',
      size: '2.4 MB',
    ...
    {
      id: '2',
      name: 'Escritura do Imóvel - Cópia Autenticada',
      category: 'Jurídico',
      size: '15.2 MB',
    ...
    {
      id: '5',
      name: 'Nota Fiscal - Manutenção Ar Condicionado',
      category: 'Financeiro',
      size: '1.2 MB',
    ...
    {
      id: '6',
      name: 'Planta Hidráulica e Elétrica',
      category: 'Técnico',
      size: '8.5 MB',
      uploadDate: '05/01/2024',
      type: 'DOCX',
    ...
    {
      id: '7',
      name: 'Seguro Fiança - Apólice Atual',
      category: 'Jurídico',
      size: '3.1 MB',
    ...
    {
      id: '8',
      name: 'Comprovante de Rendimentos Inquilino',
      category: 'Financeiro',
      size: '1.5 MB',
            ...
            filteredDocs.map((doc) => (
              ...
              >
                ...
                <div className='flex gap-1 md:gap-2 shrink-0'>
                  <button
                    className='p-1.5 md:p-2 rounded-lg bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-primary transition-colors'
                    title='Visualizar'
                  >
                    <Eye size={18} />
                  </button>
                  ...
                  <button
                    ...
                    className='p-1.5 md:p-2 rounded-lg bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-red-500 transition-colors'
                    title='Excluir'
                  >
                    <Trash2 size={18} />
                  </button>
        ...
        <div className='p-4 md:p-6 bg-white dark:bg-surface-dark border-t border-gray-100 dark:border-white/5 shrink-0 z-20'>
          <div className='flex justify-between items-center mb-2'>
            <span className='text-xs font-bold text-slate-500 uppercase'>
              Armazenamento em Nuvem (Igloo Drive)
            </span>

  ...
  return (
    ...
    >
      <form
        ...
        className='flex flex-col h-full overflow-hidden bg-background-light dark:bg-background-dark'
      >
            ...
            >
              ...
              <div className='mt-4 p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 flex items-start gap-2 text-slate-500 dark:text-slate-400'>
                ...
                <p className='text-[10px] font-medium leading-relaxed'>
                  ...
                  consumo. As fotos comprobatórias eliminam disputas entre proprietário e inquilino

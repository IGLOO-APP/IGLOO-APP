  ...
  >
    ...
    <div className='relative z-10 w-full'>
        ...
        >
          <Icon
            ...
            className={`w-5 h-5 group-hover:scale-110 transition-transform duration-500 ${
              variant === 'critical' ? 'text-red-500' : variant === 'muted' ? 'text-slate-400' : color
            }`}
          />
        </div>
        {sparkData ? (
      ...
      <div className='flex flex-col gap-0.5'>
        ...
        <h3 className={`text-xl xl:text-2xl font-black tracking-tighter truncate ${
          variant === 'muted'
    ...
    <div className='relative z-10 flex flex-wrap items-center gap-2 mt-2'>
      ...
      <span className={`text-[10px] font-bold uppercase tracking-wide line-clamp-1 ${

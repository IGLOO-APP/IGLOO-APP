        ...
        <div className='bg-slate-900 rounded-3xl p-6 text-white flex flex-col'>
          ...
          <div className='flex-1 space-y-4'>
            <div className='p-4 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group'>
              ...
              <h4 className='text-sm font-bold mb-2 group-hover:text-amber-400 transition-colors'>
                Upgrade de Última Hora
              </h4>
              <p className='text-xs text-slate-400 leading-relaxed'>
                Usuários que estão no dia 6 do Trial têm maior propensão a converter com um cupom de
                10% de desconto.
              </p>
        ...
        <div className='flex items-start gap-4'>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm text-slate-500 leading-relaxed'>
              Este painel ajuda você a entender se o IGLOO está "se pagando". A{' '}
              <strong>Taxa de Conversão</strong> é o seu KPI mais importante: ela diz quantos
              proprietários que testam o sistema realmente decidem assinar.
              <br />
              <br />
              Use os <strong>Insights de Estratégia</strong> ao lado para decidir quando é o melhor
              momento para enviar um <strong>Comunicado Global</strong> sugerindo o upgrade de
              plano.
            </p>
          </div>
        </div>

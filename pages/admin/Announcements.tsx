        ...
        {[
          {
            ...
            tooltipDesc:
              'Número total de vezes que seus comunicados foram exibidos nos dashboards dos proprietários.',
          },
          {
            ...
            tooltipDesc:
              'Total de cliques em links ou botões de "Ver Mais" dentro dos comunicados ativos.',
          },
          {
            label: 'CTR Médio',
            value: `${stats.ctr}%`,
              ...
              >
                ...
                <div className='flex-1 space-y-1'>
                  <div className='flex items-center gap-2'>
                    <span
                      className={`flex items-center gap-1 px-2 py-0.5 rounded-lg text-[9px] font-bold uppercase border ${getTypeStyles(ann.type)}`}
                    >
                      {getTypeIcon(ann.type)}
                      {ann.type}
                    </span>
                    <span
                      className={`px-2 py-0.5 rounded-lg text-[9px] font-bold uppercase ${ann.status === 'active' ? 'bg-emerald-100 text-emerald-600' : 'bg-slate-100 text-slate-400'}`}
                    >
                      {ann.status}
                    </span>
                  </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='space-y-2'>
              ...
              <p className='text-xs text-slate-300 leading-relaxed'>
                Use o público-alvo para enviar mensagens relevantes. Promoções de upgrade devem ir
                apenas para usuários no plano Free.
              </p>
            </div>
            <div className='space-y-2'>
              <h4 className='text-sm font-bold text-amber-500 uppercase tracking-widest'>
              ...
              <p className='text-xs text-slate-300 leading-relaxed'>
                Reserve o tipo 'Alerta' apenas para urgências. Para novas ferramentas, o tipo
                'Feature' gera mais engajamento visual.
              </p>
            </div>
            <div className='space-y-2'>
              <h4 className='text-sm font-bold text-amber-500 uppercase tracking-widest'>
              ...
              <p className='text-xs text-slate-300 leading-relaxed'>
                O Dashboard é o local mais nobre. Evite textos longos; prefira mensagens curtas que
                convidam para um "Ver Detalhes".
              </p>
            </div>
          </div>
        </div>

    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className='max-h-[90vh] overflow-y-auto p-0 gap-0 md:max-w-xl'>
        <DialogHeader className='px-6 py-4 border-b border-border flex-shrink-0'>
          <DialogTitle className='text-xl font-bold'>Adicionar Novo Proprietário</DialogTitle>
          <DialogDescription />
        </DialogHeader>
            ...
            <div className='flex items-center gap-4 p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl'>
              ...
              <div>
                ...
                <p className='text-xs text-slate-500 dark:text-slate-400'>
                  O proprietário será criado como "Ativo" e poderá acessar o sistema assim que
                  realizar o login com este e-mail.
                </p>
              </div>
            </div>

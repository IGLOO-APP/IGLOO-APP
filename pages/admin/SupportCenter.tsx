              ...
              <div className='space-y-2'>
                ...
                <div className='relative'>
                  ...
                  >
                    <option
                      value='Todos'
                      className='bg-white dark:bg-surface-dark text-slate-700 dark:text-white'
                    >
        ...
        {selectedTicket ? (
          <>
            ...
            <div className='flex-1 flex overflow-hidden'>
              <div className='flex-1 flex flex-col min-w-0'>
                  ...
                  {messages.map((msg: any) => (
                    ...
                    >
                      {msg.sender_role === 'system' ? (
                        ...
                        >
                          <div
                            className={`px-8 py-6 shadow-2xl relative group transition-all border-2 ${
                          ...
                          >
                            {(msg.sender_role === 'admin' || msg.sender_role === 'me') && (
                              <div className='flex items-center gap-3 mb-4 pb-4 border-b border-white/10 dark:border-slate-900/10'>
                                ...
                                <div className='ml-auto text-[8px] font-black opacity-40 uppercase tracking-widest'>
                                  ID: ADMIN_LOG
                                </div>
                              </div>
                            )}
                          ...
                          <div
                            className={`flex items-center gap-3 mt-3 px-4 ${msg.sender_role === 'admin' || msg.sender_role === 'me' ? 'flex-row-reverse' : ''}`}
                          >
                ...
                <div className='p-8 bg-white dark:bg-surface-dark border-t border-gray-100 dark:border-white/5 shrink-0'>
                  <div className='flex gap-3 overflow-x-auto hide-scrollbar mb-6 pb-2'>
                    <span className='text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] self-center mr-2'>
                      RESPOSTAS RÁPIDAS:
                    </span>
                    {['VERIFICADO', 'EM EXECUÇÃO', 'FINALIZADO', 'AGUARDANDO PROPRIETÁRIO'].map(
                      (reply, i) => (
                        <button
                          key={i}
                  ...
                  <form
                    ...
                    className='flex gap-6 items-end max-w-[1200px] mx-auto'
                  >
                    <input
                      type='file'
                      ref={fileInputRef}
              ...
              <div
                className={`w-[260px] shrink-0 bg-white dark:bg-surface-dark border-l border-gray-200 dark:border-white/5 flex-col h-full animate-slideLeft ${showDetailsPanel ? 'flex' : 'hidden'} min-[860px]:flex`}
              >
                      ...
                      <div className='space-y-3'>
                        ...
                        <div className='relative'>
                          ...
                          >
                            ...
                            <option value={currentUser?.id || ''} className='dark:bg-slate-800'>
                              Minha Fila
                            </option>
                          </select>
                          <ChevronDown
                      ...
                      <div className='space-y-3 pt-4 border-t border-gray-100 dark:border-white/5'>
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div>
                            ...
                            <p
                              className={`text-[11px] font-bold ${getSLAStatus(selectedTicket).color}`}
                            >
                    ...
                    <div className='p-4 space-y-5'>
                      <div className='flex flex-col items-center text-center pb-4 border-b border-gray-200 dark:border-white/5'>
                        ...
                        <h4 className='text-sm font-bold text-slate-900 dark:text-white'>
                          {selectedTicket.user?.name || 'Sistema'}
                        </h4>
                      ...
                      <div className='space-y-3'>
                        <div className='grid grid-cols-2 gap-2'>
                          <div className='p-2 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30'>
                            <span className='text-[9px] font-bold text-emerald-600 dark:text-emerald-400 uppercase block mb-0.5'>
                              Imóveis
                            </span>
                          ...
                          <div className='p-2 rounded-xl bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30'>
                            <span className='text-[9px] font-bold text-blue-600 dark:text-blue-400 uppercase block mb-0.5'>
                              Plano
                            </span>
                        ...
                        <div className='space-y-1.5'>
                          ...
                          {[
                            ...
                            <div
                              key={i}
                              className='flex items-center gap-2.5 p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 transition-all cursor-pointer'
                            >
          ...
          <div className='hidden md:flex flex-1 flex-col items-center justify-center text-center p-6 text-slate-400'>
            ...
            <p className='max-w-xs text-sm'>
              Selecione um ticket na lista à esquerda para iniciar o atendimento e resolver
              solicitações.
            </p>
          </div>
        )}
                ...
                <div className='flex items-center justify-between pt-2'>
                  <label className='flex items-center gap-2 cursor-pointer group'>
                    <div
                      onClick={() =>
                        editingFaq
                          ? setEditingFaq({ ...editingFaq, is_active: !editingFaq.is_active })
                          : setNewFaq({ ...newFaq, is_active: !newFaq.is_active })
                      }
                    ...
                    >
                      <div
                        className={`absolute top-1 w-3 h-3 rounded-full bg-white transition-all ${(editingFaq ? editingFaq.is_active : newFaq.is_active) ? 'left-6' : 'left-1'}`}
                      />
                    </div>
                    <span className='text-xs font-bold text-slate-500'>
                      Visível para Inquilinos
                    </span>
                  </label>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <button
                      ...
                      disabled={
                        editingFaq
                          ? !editingFaq.question || !editingFaq.answer

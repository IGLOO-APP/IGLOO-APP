  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-2'>
          <button
            ...
            className='flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 text-slate-300 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all'
          >
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 gap-3'>
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <DollarSign size={14} strokeWidth={1.8} className='text-primary' />
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Square size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              Área
            </p>
          </div>
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Bed size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              Quartos
            </p>
          </div>
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Bath size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              Banheiros
            </p>
          </div>
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Car size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              Vagas
            </p>
          </div>
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Clock size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              {timeInfo.sub}
            </p>
          </div>
        ...
        <div className='lg-card lg-card-lift p-4'>
          <div className='flex items-center gap-2 mb-1'>
            <Eye size={14} strokeWidth={1.8} className='text-primary' />
            <p className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest'>
              Visitas
            </p>
          </div>
      ...
      {tenant ? (
        <div className='lg-card lg-card-lift p-5 relative overflow-hidden'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <span className='bg-emerald-500/10 text-emerald-400 text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest border border-emerald-500/20'>
              Em dia
            </span>
          </div>
          <div className='flex items-center gap-4 mb-5 cursor-pointer' onClick={navigateToTenant}>
            <div
              className='h-14 w-14 rounded-2xl bg-cover bg-center border-2 border-white/10'
          ...
          <div className='flex gap-3'>
            <button className='flex-1 h-11 flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 text-slate-300 hover:bg-white/10 font-black text-[10px] uppercase tracking-widest transition-all'>
              <Phone size={16} strokeWidth={1.8} /> Ligar
            </button>
            <button className='flex-1 h-11 flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 text-slate-300 hover:bg-white/10 font-black text-[10px] uppercase tracking-widest transition-all'>
        ...
        <div className='lg-card lg-card-lift p-8 border border-dashed border-white/10 flex flex-col items-center justify-center text-center'>
          <div className='w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center mb-4 text-slate-400'>
          ...
          <button className='px-8 py-3 bg-white/10 backdrop-blur-xl border border-white/10 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-white/20 transition-all'>
            Anunciar Imóvel
          </button>
        </div>
      )}
      ...
      {contract && (
        <div className='lg-card lg-card-lift p-5'>
          <div className='flex items-center justify-between mb-5'>
            <h3 className='text-slate-900 dark:text-white font-black text-xs uppercase tracking-widest flex items-center gap-2'>
              <FileText size={18} strokeWidth={1.8} className='text-indigo-500' />
              Contrato
            </h3>
          ...
          <div className='space-y-4'>
            <div className='flex justify-between items-center pb-3 border-b border-white/10'>
              <span className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest flex items-center gap-2'>
                <Calendar size={14} strokeWidth={1.8} /> Início
              </span>
            ...
            <div className='flex justify-between items-center pb-3 border-b border-white/10'>
              <span className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest flex items-center gap-2'>
                <CheckCircle size={14} strokeWidth={1.8} /> Término
              </span>
              <span className='text-slate-900 dark:text-white font-bold text-sm'>
                {contract.end_date}
              </span>
            ...
            <div className='flex justify-between items-center'>
              <span className='text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest flex items-center gap-2'>
                <DollarSign size={14} strokeWidth={1.8} /> Valor Mensal
              </span>
      ...
      {tenant && property.status === 'ALUGADO' && (
        <div className='space-y-6 pt-4 border-t border-white/10'>
          <div
            ...
            className='lg-card lg-card-lift rounded-[2.5rem] overflow-hidden cursor-pointer hover:border-primary/50 transition-all group'
          >
            <div className='flex flex-col md:flex-row'>
              <div className='p-8 md:w-80 bg-white/5 border-r border-white/10 flex flex-col items-center text-center transition-colors'>
                <div className='relative mb-6'>
                  <div className='w-32 h-32 rounded-full border-4 border-white/20 overflow-hidden bg-white/5 flex items-center justify-center'>
                    {tenant.image ? (
                      <img src={tenant.image} className='w-full h-full object-cover' alt='' />
                    ) : (
                      <User size={48} strokeWidth={1.8} className='text-slate-300' />
                    )}
                  </div>
                  {(tenant.is_verified || tenant.email === 'arthur.raul94@gmail.com') && (
                    <div
                      className='absolute bottom-1 right-1 bg-primary text-white p-2 rounded-full border-2 border-white/20'
                ...
                <div className='flex gap-3 w-full'>
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    className='flex-1 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-primary hover:border-primary transition-all'
                  >
                    <MessageSquare size={20} strokeWidth={1.8} />
                  </a>
                  <a
                    href={`tel:${tenant.phone}`}
                    className='flex-1 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-emerald-500 hover:border-emerald-500 transition-all'
                  >
                    <Phone size={20} strokeWidth={1.8} />
                  </a>
                  <a
                    href={`mailto:${tenant.email}`}
                    className='flex-1 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-blue-500 hover:border-blue-500 transition-all'
                  >
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      >
                        {isLate ? <AlertCircle size={24} strokeWidth={1.8} /> : <TrendingUp size={24} strokeWidth={1.8} />}
                      </div>
                      <div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            <div className='lg-card lg-card-lift p-4 flex items-center gap-3'>
              <div className='w-10 h-10 rounded-xl bg-white/5 text-emerald-500 flex items-center justify-center'>
            ...
            <div className='lg-card lg-card-lift p-4 flex items-center gap-3'>
              <div className='w-10 h-10 rounded-xl bg-white/5 text-amber-500 flex items-center justify-center'>

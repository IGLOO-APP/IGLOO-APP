      ...
      {steps.map((step, index) => {
        ...
        return (
          ...
          >
            ...
            {isNext && (
              <div
                className={`absolute -inset-1 bg-gradient-to-r from-${step.color.split('-')[1]}-500/10 to-transparent blur-xl opacity-50 group-hover:opacity-100 transition-opacity`}
              />
            )}
            ...
            <div className='relative z-10'>
              <div className='flex flex-col gap-1'>
                <h3
                  className={`text-sm md:text-xl font-black tracking-tight leading-tight transition-colors ${
                    step.completed

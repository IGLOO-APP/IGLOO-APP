    ...
    <div className='w-full h-full bg-white dark:bg-surface-dark p-6 md:p-8 rounded-[32px] border border-slate-200/60 dark:border-white/5 shadow-premium flex flex-col'>
      <div className='flex items-center justify-between mb-8'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <h3 className='font-black text-base text-slate-main dark:text-white uppercase tracking-tight'>Igloo Insights</h3>
            <p className='text-[10px] text-slate-muted font-bold uppercase tracking-widest'>Financial Advisor</p>
          </div>
        </div>
        <div className='flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5'>
          ...
          <span className='text-[8px] font-black uppercase tracking-[0.2em] text-slate-muted'>Live Analysis</span>
        </div>
      </div>
      ...
      <div className='space-y-4 flex-grow'>
        ...
        <div className='flex items-start gap-4 p-5 rounded-[24px] bg-slate-50/50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5 transition-all'>
          ...
          <div className='space-y-1'>
            <p className='text-[10px] font-black uppercase tracking-widest text-slate-muted'>Ocupação da Carteira</p>
            <p className='text-sm font-bold text-slate-body dark:text-slate-200 leading-relaxed'>
              {occupancyRate < 80
        ...
        {pendingMaintenanceCount > 0 && (
          <div className='flex items-start gap-4 p-5 rounded-[24px] bg-slate-50/50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5 transition-all'>
            ...
            <div className='space-y-1'>
              <p className='text-[10px] font-black uppercase tracking-widest text-slate-muted'>Manutenção Preventiva</p>
              <p className='text-sm font-bold text-slate-body dark:text-slate-200 leading-relaxed'>
        ...
        <div className='flex items-start gap-4 p-5 rounded-[24px] bg-slate-50/50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5 transition-all'>
          ...
          <div className='space-y-1'>
            <p className='text-[10px] font-black uppercase tracking-widest text-slate-muted'>Vigência de Contratos</p>
            <p className='text-sm font-bold text-slate-body dark:text-slate-200 leading-relaxed'>
      ...
      <div className='mt-6'>
        <button className='w-full py-3.5 rounded-xl bg-slate-50 dark:bg-white/5 text-slate-body dark:text-slate-400 font-bold text-[10px] uppercase tracking-widest border border-slate-100 dark:border-white/5 hover:bg-slate-100 dark:hover:bg-white/10 transition-all active:scale-95 flex items-center justify-center gap-2'>
          Ver Recomendações

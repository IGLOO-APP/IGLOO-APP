  ...
  root.render(
    ...
    >
      ...
      <p style={{ maxWidth: '400px', lineHeight: '1.6', color: '#94a3b8' }}>
        O iGloo não conseguiu encontrar a chave de acesso (Clerk). Isso acontece quando o Vercel
        ainda não terminou o processamento das variáveis de ambiente.
      </p>
      <div
        style={{
          background: '#141b1d',
      ...
      >
        <p style={{ fontSize: '13px', margin: 0 }}>
          Ação necessária: <strong>Faça um Redeploy no Vercel</strong>.
        </p>
      </div>
    </div>
  );

...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      staleTime: 1000 * 30, // Cache valid for 30s to avoid excessive network calls
      ...
      children: [
        ...
        // Tenant Routes
        {
          ...
          children: [
            ...
            { path: 'maintenance', element: <Navigate to='/tenant/messages' replace /> },
            { path: 'profile', element: <TenantProfile /> },
            { path: 'messages', element: <TenantMaintenance /> },
            ...
            { index: true, element: <AdminDashboard /> },
            {
              ...
              loader: async () => {
                await queryClient.prefetchQuery({
                  ...
                  queryFn: () =>
                    adminService.getUsers(1, 10, '', 'Todos', 'Todos', 'Todos', 'Todos'),
                });
                return null;
              },
            },

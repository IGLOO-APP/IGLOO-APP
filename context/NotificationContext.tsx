...
function loadPrefs(): NotificationPrefs {
  try {
    const stored = localStorage.getItem('igloo_notification_prefs');
...
function isNotificationAllowed(type: string): boolean {
  const prefs = loadPrefs();
  switch (type) {
    case 'payment':
      return prefs.paymentReceived || prefs.latePayment;
    case 'maintenance':
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (!isNotificationAllowed(newNotification.type)) return;
